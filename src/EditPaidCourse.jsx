...
const EditPaidCourse = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (file === undefined) {
            ...
            formData.append('des', data.detail);
        ...
        await axios.put(`${process.env.REACT_APP_BASE_URL}/update/arnab/${id}`, formData, config)
        .then((res) => {
            ...
            <div className="flex flex-row">
                ...
                <form onSubmit={handleSubmit} encType='multipart/form-data' className={`${position} w-full`}>
                    <div className="lg:w-[100%] md:w-full bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                        <h2 className="text-gray-900 text-lg font-medium title-font mb-5">Edit Paid Course</h2>
                        ...
                        <div className="relative mb-4">
                            ...
                            <input type="number" id="price" value={data&&data.price}
                                onChange={handleChange}
                                name="price" min={0} className="w-full bg-white rounded border border-gray-300 focus:border-[#0b5076] focus:ring-2 focus:ring-[#69caff] text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                        </div>
                        <div className="relative mb-4">
