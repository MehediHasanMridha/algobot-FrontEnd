...
const PaidUser = () => {
    ...
    const getData = async () => {
        await axios.get(`${process.env.REACT_APP_BASE_URL}/paidRegi/get`)
            .then((res) => {
                setData(res.data);
    ...
    const delete_data = (id) => {
        axios.delete(`${process.env.REACT_APP_BASE_URL}/paidRegi/${id}`).then((res) => {
            ...
            <div className="flex flex-row">
                ...
                <div className={`${position} w-full lg:w-[80%] bg-gray-400 text-center relative`}>
                    <div className="text-2xl flex flex-row justify-center bg-[#207daf] p-5">
                        <div className="w-[80%]">Paid User</div>
                    </div>
