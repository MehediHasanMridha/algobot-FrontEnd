...
const PromoCode = () => {
    ...
    const getData = async () => {
        await axios.get(`${process.env.REACT_APP_BASE_URL}/get/promo`)
            .then((res) => {
                setData(res.data);
    ...
    const delete_data = (id) => {
        axios.delete(`${process.env.REACT_APP_BASE_URL}/manage/promo/${id}`).then((res) => {
            ...
            <div className="flex flex-row">
                ...
                <div className={`${position} w-full lg:w-[80%] bg-gray-400 text-center relative`}>
                    <div className="text-2xl flex flex-row justify-center bg-[#207daf] p-5">
                        ...
                        <div className="w-[80%]">PromoCode</div>
                    </div>
