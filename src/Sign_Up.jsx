                ...
                <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
                    ...
                    <form onSubmit={handleSubmit} className="max-w-lg border rounded-lg mx-auto">
                        <div className="flex flex-col gap-4 p-4 md:p-8">
                            <div>
                                <label htmlFor="Full_name" className="inline-block text-gray-800 text-sm sm:text-base mb-2">Full Name</label>
                                <input value={values.Full_name}
                                    onChange={handleChange}
                                    onBlur={handleBlur} name="Full_name" className="w-full bg-gray-50 text-gray-800 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2" />
                            ...
                            <div>
                                ...
                                <input value={values.Password}
                                    onChange={handleChange}
                                    onBlur={handleBlur} type="password" name="Password" className="w-full bg-gray-50 text-gray-800 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2" />
                                {errors.Password && touched.Password ? (
                                    <p className="text-red-600">{errors.Password}</p>
                                ) : null}
                            </div>
                            <div>
                                <label htmlFor="Confirm_Password" className="inline-block text-gray-800 text-sm sm:text-base mb-2">Confirm Password</label>
                                <input value={values.Confirm_Password}
                                    onChange={handleChange}
                                    onBlur={handleBlur} type="password" name="Confirm_Password" className="w-full bg-gray-50 text-gray-800 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2" />
                                {errors.Confirm_Password && touched.Confirm_Password ? (
                                    <p className="text-red-600">{errors.Confirm_Password}</p>
                                ) : null}
                            </div>
                            <input type="submit" className="block bg-gray-800 hover:bg-gray-700 active:bg-gray-600 focus-visible:ring ring-gray-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3 cursor-pointer" value="Sign Up" />
                        ...
                        <div className="flex justify-center items-center bg-gray-100 p-4">
                            <p className="text-gray-500 text-sm text-center">You have an account? <Link to={"/login"} className="text-indigo-500 hover:text-indigo-600 active:text-indigo-700 transition duration-100">Login</Link></p>
                        </div>
                    </form>
                </div>
            </div>
